 ...
 //       }
    ...
    public void weaponChoice(int speed,char dir,float stateTime2) {
        if(stateTime2 > 1) {
            ...
            if (speed >= 3) {
                if(random2%2==0) {
                    bullets.add(new Shotgun(x+spritesheet.getWidth()/32, y+spritesheet.getHeight()/8, dir, 'e'));
                }
            } else if (speed == 2) {
                if(random2%2==0) {
                    bullets.add(new Pistol(x+spritesheet.getWidth()/32, y+spritesheet.getHeight()/8, dir, 'e'));
                }
            } else if (speed == 1) {
                for(int i = 0; i < random2; i++){
                    bullets.add(new MachineGun(x+spritesheet.getWidth()/32, y+spritesheet.getHeight()/8,dir, 'e'));
                }
            }
        }
